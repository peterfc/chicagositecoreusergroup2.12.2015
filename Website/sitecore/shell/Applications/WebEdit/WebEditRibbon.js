...
function scNavigate(href) {
  var absoluteUrl = /^(?:[a-z]+:)?\/\//i; // eg. begins with "http://", "https://", "//"
  if (window.parent.location.origin != null && !absoluteUrl.test(href)) {
    window.parent.location.href = window.parent.location.origin + href;
  } else {
